...
space_variable <- expand.grid(tAvg14.1 = seq(min(df_datapoint$tAvg14.1), max(df_datapoint$tAvg14.1), by = 0.5),hMin14.1 = seq(min(df_datapoint$hMin14.1), max(df_datapoint$hMin14.1), by = 1))
